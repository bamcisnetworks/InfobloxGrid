...
namespace BAMCIS.Infoblox.PowerShell
{
    internal static class PSExtensionMethods
    {
        ...
        public static T GetUnboundValue<T>(this PSCmdlet cmdlet, string paramName)
        {
            return cmdlet.GetUnboundValue<T>(paramName, -1);
        }

        public static T GetUnboundValue<T>(this PSCmdlet cmdlet, int unnamedPosition)
        {
            return cmdlet.GetUnboundValue<T>(String.Empty, unnamedPosition);
        }

        public static T GetUnboundValue<T>(this PSCmdlet cmdlet, string paramName, int unnamedPosition)
        {
        ...
        public static object TryGetProperty(object instance, string fieldName)
        {
        ...
        public static async Task<object> InvokeGenericAsync(this MethodInfo @this, object obj, params object[] parameters)
        {
