...
namespace BAMCIS.Infoblox.PowerShell.Zone
{
    ...
    public class SetDhcpObjectPSCmd : BaseIbxObjectPSCmd, IDynamicParameters
    {
        ...
        [Parameter(
          ...
          Mandatory = true,
          HelpMessage = "The zone object reference string."
           )]
        [Alias("Ref")]
        ...
        [Parameter(
            ...
            HelpMessage = "Set to define the new zone by attributes.")]
        ...
        [Parameter(
            ...
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = true,
            ParameterSetName = "ByObjectRemoveEmpty",
            HelpMessage = "The object to be updated."
            )]
        [Parameter(
            Mandatory = true,
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = true,
            ParameterSetName = "ByObjectKeepEmpty",
            HelpMessage = "The object to be updated."
            )]
        ...
        public override object GetDynamicParameters()
        {
            ...
            if (!this.ParameterSetName.Equals("ByObject"))
            {
                ...
                string recordType = base.GetUnboundValue("ZoneType") as string;
        ...
        private void ProcessByAttribute()
        {
            if (base.ParameterDictionary.ContainsKey("ZoneType"))
            {
                ...
                {
                    throw new PSArgumentException(String.Format("Zone object type parameter was not an allowed value, {0} was provided.", val));
                }
            }
            else
            {
